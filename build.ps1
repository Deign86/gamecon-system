...
# If no specific flag is passed, build everything
...
# ════════════════════════════════════════════════════════════════════════════
#  TAURI BUILD  (Rust + NSIS installer)
# ════════════════════════════════════════════════════════════════════════════
if ($Tauri) {
    ...
    # Locate the NSIS installer output
...
# ════════════════════════════════════════════════════════════════════════════
#  ANDROID BUILD  (Capacitor → Gradle → debug APK)
# ════════════════════════════════════════════════════════════════════════════
if ($Android) {
    Write-Step "Syncing Capacitor assets to Android..."
    $t = Get-Date

    # Make sure web assets are built before syncing
